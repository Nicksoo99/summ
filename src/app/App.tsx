  ...
  return (
    <div className="min-h-screen bg-background text-foreground" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50">
        ...
        {/* Top info strip */}
        <div
          className="bg-[#0a1628] transition-all duration-500 overflow-hidden"
          style={{ height: scrolled ? 0 : 32, opacity: scrolled ? 0 : 1 }}
        >
          <div className="max-w-7xl mx-auto px-5 lg:px-10 h-8 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="text-sky-400 text-[10px]" style={{ fontFamily: "'DM Mono', monospace" }}>✦</span>
              <span className="text-sky-300/70 text-[11px] font-medium" style={{ fontFamily: "'DM Mono', monospace" }}>
                Where Quality Meets Affordability — Summit Mabati Factory
              </span>
            </div>
            <div className="flex items-center gap-5">
              <a href={FACEBOOK_URL} target="_blank" rel="noopener noreferrer"
                className="text-sky-400/60 hover:text-sky-300 transition-colors" aria-label="Facebook">
                <Facebook size={13} />
              </a>
              <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer"
                className="text-sky-400/60 hover:text-sky-300 transition-colors" aria-label="Instagram">
                <Instagram size={13} />
              </a>
              <div className="h-3 w-px bg-sky-700" />
              <a href={`tel:${PHONE}`}
                className="flex items-center gap-1.5 text-sky-300 text-[11px] font-semibold hover:text-white transition-colors"
                style={{ fontFamily: "'DM Mono', monospace" }}>
                <Phone size={10} /> {PHONE_DISPLAY}
              </a>
            </div>
          </div>
        </div>
